...
This is a full stack project developed @ "Semana Spring React" promoted by Devsuperior. It displays the sales report and sends notifications to the seller phone number with the informations about the sales.
